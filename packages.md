...
|[amdgpu](http://support.amd.com/en-us/download)|[21.50.2](https://repo.radeon.com/amdgpu-install/21.50.2/)|AMDGPU: a device driver and utility software package for AMD's graphics cards and APUs
|[apache-tomcat](http://tomcat.apache.org/)|[10.0.18](http://www.apache.org/dist/tomcat/tomcat-10/v10.0.18/src/apache-tomcat-10.0.18-src.tar.gz)|apache-tomcat: a Java Servlet and JSP Container
|[apt](https://packages.qa.debian.org/a/apt.html)|[2.4.3](https://ftp.debian.org/debian/pool/main/a/apt/apt_2.4.3.tar.xz)|APT: a front-end for the dpkg package manager
...
|[binutils](http://www.gnu.org/software/binutils/binutils.html)|[2.38](https://ftp.gnu.org/gnu/binutils/binutils-2.38.tar.gz)|GNU Binutils: an essential collection of binary utilities
...
|[bitcoin](https://bitcoin.org/)|[22.0](https://github.com/bitcoin/bitcoin/archive/v22.0.tar.gz)|Bitcoin: an innovative payment network and a new kind of money
|[blender](https://www.blender.org/)|[3.1.0](https://download.blender.org/source/blender-3.1.0.tar.xz)|Blender: a very fast and versatile 3D modeller and renderer
|[budgie-desktop](https://github.com/BuddiesOfBudgie/budgie-desktop)|[10.6](https://github.com/BuddiesOfBudgie/budgie-desktop/releases/download/v10.6/budgie-desktop-v10.6.tar.xz)|Budgie Desktop: a simple desktop environment featuring heavy integration with the GNOME stack
...
|[cacti](http://www.cacti.net/)|[1.2.19](http://www.cacti.net/downloads/cacti-1.2.19.tar.gz)|Cacti: a complete network graphing solution
|[calibre](http://calibre-ebook.com/)|[5.39.1](https://download.calibre-ebook.com/5.39.1/calibre-5.39.1.tar.xz)|Calibre: an e-book library management application
...
|[cdrkit](https://packages.debian.org/source/sid/cdrkit)|[1.1.11](http://cdrkit.org/releases/cdrkit-1.1.11.tar.gz)|cdrkit: a collection of applications related to creation of optical disk media
|[chromium](http://www.chromium.org/Home)|[99.0.4844.84](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[cmake](https://cmake.org/)|[3.22.3](https://github.com/Kitware/CMake/releases/download/v3.22.3/cmake-3.22.3.tar.gz)|cmake: a cross-platform, open-source build system
...
|[coreutils](https://www.gnu.org/software/coreutils/)|[9.0](https://ftp.gnu.org/gnu/coreutils/coreutils-9.0.tar.xz)|GNU Coreutils: provides basic file, shell and text manipulation utilities
...
|[dnf](https://github.com/rpm-software-management/dnf/)|[4.11.1](https://github.com/rpm-software-management/dnf/archive/4.11.1.tar.gz)|DNF: a new package management library and a fork of yum
...
|[doxygen](http://www.doxygen.nl/)|[1.9.3](http://doxygen.nl/files/doxygen-1.9.3.src.tar.gz)|Doxygen: a documentation system for C++, Java, C and IDL
...
|[efibootmgr](https://github.com/rhinstaller/efibootmgr)|[17](https://github.com/rhinstaller/efibootmgr/releases/download/17/efibootmgr-17.tar.bz2)|efibootmgr: a Linux user-space application to modify the Intel EFI boot manager
|[emacs](http://www.gnu.org/software/emacs/)|[27.2](https://ftp.gnu.org/gnu/emacs/emacs-27.2.tar.xz)|GNU Emacs: the extensible, self-documenting real-time display editor
...
|[evolution](https://wiki.gnome.org/Apps/Evolution)|[3.44.0](https://download.gnome.org/sources/evolution/3.42/evolution-3.44.0.tar.xz)|Evolution: information management software providing mail, address book and calendaring functionality
|[exim](https://www.exim.org/)|[4.95](https://ftp.exim.org/pub/exim/exim4/exim-4.95.tar.xz)|exim: a mail server
|[ffmpeg](http://ffmpeg.org/)|[5.0](http://ffmpeg.org/releases/ffmpeg-5.0.tar.xz)|FFmpeg: a complete, cross-platform solution to record, convert and stream audio and video
|[file](http://www.darwinsys.com/file/)|[5.41](http://ftp.astron.com/pub/file/file-5.41.tar.gz)|file: a program that attempts to classify files by their content
...
|[firebird](http://www.firebirdsql.org/)|[4.0.1](https://github.com/FirebirdSQL/firebird/archive/refs/tags/v4.0.1.tar.gz)|Firebird: a relational database offering many ANSI SQL standard features that runs on Linux, Windows and UNIX
|[firefox](http://www.mozilla.org/products/firefox/)|[98.0.2](https://ftp.mozilla.org/pub/firefox/releases/98.0.2/source/firefox-98.0.2.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
|[firejail](https://firejail.wordpress.com/)|[0.9.68](http://downloads.sourceforge.net/firejail/firejail-0.9.68.tar.xz)|Firejail: a Linux namespaces sandbox program
|[flatpak](http://flatpak.org)|[1.12.7](https://github.com/flatpak/flatpak/releases/download/1.12.7/flatpak-1.12.7.tar.xz)|Flatpak: a framework for Linux application sandboxing and distribution
...
|[freecad](https://www.freecadweb.org/)|[0.19.4](https://github.com/FreeCAD/FreeCAD/archive/0.19.4.tar.gz)|FreeCAD: a general purpose parametric 3D modeller for CAD
|[freetype](https://www.freetype.org/)|[2.11.1](http://downloads.sourceforge.net/freetype/freetype-2.11.1.tar.xz)|FreeType: a free, quality, portable font engine
...
|[ghostscript](http://www.ghostscript.com/)|[9.55.0](https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs9540/ghostscript-9.55.0.tar.gz)|Ghostscript: an interpreter for the PostScript language and PDF
|[gimp](https://www.gimp.org/)|[2.10.30](https://download.gimp.org/mirror/pub/gimp/v2.10/gimp-2.10.30.tar.bz2)|GIMP: the GNU Image Manipulation Program
|[git](https://git-scm.com/)|[2.35.1](https://github.com/git/git/archive/v2.35.1.tar.gz)|Git: an open source version control system
|[glade](https://glade.gnome.org/)|[3.38.2](https://download.gnome.org/sources/glade/3.38/glade-3.38.2.tar.xz)|Glade: a GUI builder for GTK+ and GNOME
...
|[gnome-shell](https://wiki.gnome.org/Projects/GnomeShell)|[42.0](https://download.gnome.org/sources/gnome-shell/41/gnome-shell-42.0.tar.xz)|GNOME Shell: a core user interface of the GNOME 3 desktop
|[gnucash](http://www.gnucash.org/)|[4.10](http://downloads.sourceforge.net/gnucash/gnucash-4.10.tar.bz2)|GNUCash: an open source personal finance suite
|[gnumeric](http://www.gnumeric.org/)|[1.12.51](https://download.gnome.org/sources/gnumeric/1.12/gnumeric-1.12.51.tar.xz)|Gnumeric: a spreadsheet and a part of the GNOME Desktop
|[gnupg](https://www.gnupg.org/)|[2.3.4](https://gnupg.org/ftp/gcrypt/gnupg/gnupg-2.3.4.tar.bz2)|GnuPG: a tool for secure communication and data storage
...
|[gstreamer](https://gstreamer.freedesktop.org/)|[1.20.1](https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.20.1.tar.xz)|GStreamer: a multimedia framework with a plugin-based architecture for a variety of platforms
|[gtk](https://www.gtk.org/)|[4.6.2](https://download.gnome.org/sources/gtk/4.6/gtk-4.6.2.tar.xz)|GTK: a multi-platform toolkit for creating GUIs
|[gzip](http://www.gnu.org/software/gzip/gzip.html)|[1.11](https://ftp.gnu.org/gnu/gzip/gzip-1.11.tar.gz)|gzip: a compression utility designed to replace compress
|[hexchat](https://hexchat.github.io/)|[2.16.1](https://dl.hexchat.net/hexchat/hexchat-2.16.1.tar.xz)|HexChat: an IRC client
|[hplip](https://developers.hp.com/hp-linux-imaging-and-printing)|[3.22.2](http://downloads.sourceforge.net/hplip/hplip-3.22.2.tar.gz)|hplip: Hewlett-Packard's Linux imaging and printing software
...
|[icewm](https://ice-wm.org/)|[2.9.6](https://github.com/ice-wm/icewm/releases/download/2.9.6/icewm-2.9.6.tar.lz)|IceWM: an X Window manager that emulates the looks of Motif, OS/2 and Windows
|[ImageMagick](http://www.imagemagick.org/)|[7.1.0-29](https://github.com/ImageMagick/ImageMagick/archive/7.1.0-29.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[k3b](http://www.k3b.org/)|[21.12.3](https://github.com/KDE/k3b/archive/v21.12.3.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
|[kdevelop](https://www.kdevelop.org/)|[21.12.2](https://github.com/KDE/kdevelop/archive/refs/tags/v21.12.2.tar.gz)|KDevelop: a C/C++ development environment
...
|[krita](https://krita.org/)|[5.0.2](https://download.kde.org/stable/krita/5.0.2/krita-5.0.2.tar.xz)|Krita: a cross-platform application that offers an end-to-end solution for creating digital art files from scratch
...
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[21.12.3](https://github.com/KDE/ktorrent/archive/v21.12.3.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[libreoffice](http://www.libreoffice.org/)|[7.3.1](https://download.documentfoundation.org/libreoffice/stable/7.3.1/)|LibreOffice: a free personal productivity suite
|[libressl](http://www.libressl.org/)|[3.4.3](http://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-3.4.3.tar.gz)|LibreSSL: an implementation of SSL and TLS protocols, forked from OpenSSL
|[libselinux](http://userspace.selinuxproject.org/)|[3.3](https://github.com/SELinuxProject/selinux/archive/libselinux-3.3.tar.gz)|libselinux: a library providing an interface for security-aware applications in SELinux
...
|[libvirt](http://libvirt.org/)|[8.1.0](https://libvirt.org/sources/libvirt-8.1.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[links](http://links.twibright.com/)|[2.25](http://links.twibright.com/download/links-2.25.tar.bz2)|Links: a text and graphics mode web browser similar to Lynx
|[linux](https://www.kernel.org/)|[5.17.1](https://www.kernel.org/pub/linux/kernel/v5.x/linux-5.17.1.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](http://llvm.org/)|[14.0.0](https://github.com/llvm/llvm-project/releases/download/llvmorg-14.0.0/llvm-14.0.0.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[lvm](https://sourceware.org/lvm2/)|[2.03.15](https://sourceware.org/pub/lvm2/LVM2.2.03.15.tgz)|LVM: the logical volume manager
...
|[lxqt-panel](https://github.com/lxqt/lxqt-panel)|[1.0.0](https://github.com/lxde/lxqt-panel/releases/download/1.0.0/lxqt-panel-1.0.0.tar.xz)|LXQt: a Qt port of the LXDE desktop environment
...
|[mesa](http://www.mesa3d.org/)|[22.0.0](https://mesa.freedesktop.org/archive/mesa-22.0.0.tar.xz)|Mesa: a 3D graphics library
...
|[mutt](http://www.mutt.org/)|[2.2.2](http://ftp.mutt.org/pub/mutt/mutt-2.2.2.tar.gz)|Mutt: a text-based MIME Email client
...
|[nano](https://www.nano-editor.org/)|[6.2](https://www.nano-editor.org/dist/latest/nano-6.2.tar.gz)|GNU nano: a curse-based text editor for UNIX
|[nautilus](https://wiki.gnome.org/Apps/Files)|[42.0](https://download.gnome.org/sources/nautilus/42/nautilus-42.0.tar.xz)|Nautilus: a file manager for the GNOME desktop
...
|[octave](http://www.gnu.org/software/octave/)|[6.4.0](http://ftp.gnu.org/gnu/octave/octave-6.4.0.tar.xz)|GNU Octave: a high-level interpreted language intended for numerical computations
...
|[openjdk](https://openjdk.java.net/)|[18](https://download.java.net/java/GA/jdk18/43f95e8614114aeaa8e8a5fcf20a682d/36/GPL/openjdk-18_linux-x64_bin.tar.gz)|OpenJDK: a complete and free implementation of Java SE, the core Java platform
|[openldap](https://www.openldap.org/)|[2.6.1](https://openldap.org/software/download/OpenLDAP/openldap-release/openldap-2.6.1.tgz)|OpenLDAP: a full-featured open source LDAP software suite
...
|[openssh](http://www.openssh.com/portable.html)|[8.9p1](https://ftp3.usa.openbsd.org/pub/OpenBSD/OpenSSH/portable/openssh-8.9p1.tar.gz)|OpenSSH: a client and server for encrypted remote logins and file transfers
|[openssl](https://www.openssl.org/)|[3.0.2](https://ftp.openssl.org/source/openssl-3.0.2.tar.gz)|OpenSSL: a library for providing encrypted transport layers
|[opera](http://www.opera.com/)|[85.0.4341.18](http://ftp.opera.com/pub/opera/desktop/85.0.4341.18/linux/)|Opera: a light-weight graphical web browser
...
|[parted](http://www.gnu.org/software/parted/parted.html)|[3.4](https://ftp.gnu.org/gnu/parted/parted-3.4.tar.xz)|GNU Parted: a program to create, destroy, resize and copy PC disk partitions
...
|[php](http://www.php.net/)|[8.1.4](http://us3.php.net/distributions/php-8.1.4.tar.xz)|PHP: a server-side HTML embedded scripting language
...
|[pidgin](http://pidgin.im/)|[2.14.8](http://downloads.sourceforge.net/pidgin/pidgin-2.14.8.tar.bz2)|Pidgin: an instant messenger client for several protocols (formerly GAIM)
|[pipewire](https://pipewire.org/)|[0.3.48](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.48/pipewire-0.3.48.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.24.3](https://download.kde.org/stable/plasma/5.24.3/plasma-desktop-5.24.3.tar.xz)|Plasma Desktop: a desktop environment
|[postfix](http://www.postfix.org/)|[3.7.0](https://de.postfix.org/ftpmirror/official//postfix-3.7.0.tar.gz)|Postfix: a mail transport agent
...
|[qbittorrent](https://www.qbittorrent.org/)|[4.4.2](http://downloads.sourceforge.net/qbittorrent/qbittorrent-4.4.2.tar.xz)|qBittorrent: a P2P BitTorrent client
|[qemu](http://wiki.qemu.org/)|[6.2.0](http://wiki.qemu.org/download/qemu-6.2.0.tar.xz)|QEMU: an open source machine emulator and virtualiser
|[qt](https://qt-project.org/)|[6.2.4](https://download.qt-project.org/official_releases/qt/6.2/6.2.4/single/qt-everywhere-src-6.2.4.tar.xz)|Qt: a C++ application framework for writing graphical applications
|[qt-creator](https://wiki.qt.io/Qt_Creator)|[7.0.0](https://download.qt.io/official_releases/qtcreator/7.0/7.0.0/qt-creator-opensource-src-7.0.0.tar.gz)|Qt Creator: a cross-platform IDE tailored to the needs of Qt developers
...
|[rpm](https://rpm.org/)|[4.17.0](https://github.com/rpm-software-management/rpm/archive/refs/tags/rpm-4.17.0.tar.gz)|RPM: a package management system originally developed by Red Hat
...
|[ruby](http://www.ruby-lang.org/)|[3.1.1](https://ftp.ruby-lang.org/pub/ruby/3.1/ruby-3.1.1.tar.xz)|Ruby: interpreted, dynamically typed, pure object-oriented scripting language
|[rust](https://www.rust-lang.org/)|[1.59.0](https://github.com/rust-lang/rust/archive/1.59.0.tar.gz)|Rust: a systems programming language that runs blazingly fast, prevents segfaults and guarantees thread safety
|[samba](https://www.samba.org/)|[4.16.0](https://us1.samba.org/samba/ftp/stable/samba-4.16.0.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[seamonkey](http://www.seamonkey-project.org/)|[2.53.11.1](https://ftp.mozilla.org/pub/seamonkey/releases/2.53.11.1/source/seamonkey-2.53.11.1.source.tar.xz)|Mozilla SeaMonkey: a web browser, e-mail and newsgroup client, IRC chat client and HTML editor
...
|[shotwell](https://wiki.gnome.org/Apps/Shotwell)|[0.30.14](https://download.gnome.org/sources/shotwell/0.30/shotwell-0.30.14.tar.xz)|Shotwell: an open-source digital photo organiser for GNOME
|[snapd](https://snapcraft.io/)|[2.55.2](https://github.com/snapcore/snapd/archive/2.55.2.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
...
|[squid](http://www.squid-cache.org/)|[5.4.1](http://www.squid-cache.org/Versions/v5/squid-5.4.1.tar.xz)|Squid: a full-featured web proxy cache
|[subversion](http://subversion.apache.org/)|[1.14.1](http://www.apache.org/dist/subversion/subversion-1.14.1.tar.bz2)|Subversion: a version control system
...
|[synaptic](https://packages.qa.debian.org/s/synaptic.html)|[0.90.2](http://ftp.debian.org/debian/pool/main/s/synaptic/synaptic_0.90.2.+nmu1.tar.xz)|Synaptic: a graphical front-end for APT
|[systemd](http://www.freedesktop.org/wiki/Software/systemd/)|[250.4](https://github.com/systemd/systemd-stable/archive/refs/tags/v250.4.tar.gz)|systemd: a system and service manager for Linux
|[sysvinit](https://github.com/slicer69/sysvinit)|[3.02](https://github.com/slicer69/sysvinit/releases/download/3.02/sysvinit-3.02.tar.xz)|SysVinit: the Linux System V Init
...
|[texlive](http://www.tug.org/texlive/)|[2021](http://tug.org/texlive/Images/texlive2021.iso)|TeX Live: a collection of programs for typesetting, previewing and printing of TeX documents
|[thunderbird](http://www.mozilla.org/products/thunderbird/)|[91.7.0](https://ftp.mozilla.org/pub/thunderbird/releases/91.7.0/source/thunderbird-91.7.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[tmux](http://tmux.github.io/)|[3.2a](https://github.com/tmux/tmux/releases/download/3.2a/tmux-3.2a.tar.gz)|tmux: a terminal multiplexer
|[tor](http://www.torproject.org/)|[0.4.6.10](http://www.torproject.org/dist/tor-0.4.6.10.tar.gz)|Tor: a network of virtual tunnels that allows people to improve privacy and security on the Internet
...
|[vivaldi](https://vivaldi.com/)|[5.1.2567](https://source.vivaldi.com/vivaldi-source_5.1.2567.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[webmin](http://www.webmin.com/)|[1.990](http://downloads.sourceforge.net/webadmin/webmin-1.990.tar.gz)|Webmin: a web-based interface for Unix system administration
...
|[wordpress](https://wordpress.org/)|[5.9.2](https://wordpress.org/wordpress-5.9.2.tar.gz)|WordPress: publishing software for the world wide web
...
|[xfsprogs](http://xfs.org/)|[5.14.2](https://www.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-5.14.2.tar.xz)|xfsprogs: a set of utilities for managing the XFS file system
...
|[zfs](https://openzfs.org/)|[2.1.4](https://github.com/openzfs/zfs/releases/download/zfs-2.1.4/zfs-2.1.4.tar.gz)|ZFS: an advanced file system and volume manager maintained by the Illumos community
|[zlib](http://www.zlib.net/)|[1.2.11](http://www.zlib.net/zlib-1.2.11.tar.xz)|zlib: a legally unencumbered lossless data compression library
*** 
- 快捷下载
```
wget -c --no-check-certificate https://distrowatch.com/packages.php
