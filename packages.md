...
|[audacity](http://www.audacityteam.org/)|[3.2.0](http://www.fosshub.com/Audacity.html/audacity-minsrc-3.2.0.tar.xz)|Audacity: a free audio editor
...
|[calibre](http://calibre-ebook.com/)|[6.5.0](https://download.calibre-ebook.com/6.5.0/calibre-6.5.0.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[105.0.5195.125](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[ffmpeg](http://ffmpeg.org/)|[5.1.1](http://ffmpeg.org/releases/ffmpeg-5.1.1.tar.xz)|FFmpeg: a complete, cross-platform solution to record, convert and stream audio and video
...
|[ImageMagick](https://imagemagick.org/)|[7.1.0-48](https://github.com/ImageMagick/ImageMagick/archive/7.1.0-48.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[linux](https://www.kernel.org/)|[5.19.11](https://www.kernel.org/pub/linux/kernel/v5.x/linux-5.19.11.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
...
|[nuspell](https://nuspell.github.io/)|[5.1.1](https://github.com/nuspell/nuspell/archive/refs/tags/v5.1.1.tar.gz)|Nuspell: a spelling checker software program
...
|[pipewire](https://pipewire.org/)|[0.3.58](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.58/pipewire-0.3.58.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[snapd](https://snapcraft.io/)|[2.57.3](https://github.com/snapcore/snapd/archive/2.57.3.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
...
|[thunderbird](http://www.mozilla.org/products/thunderbird/)|[102.3.0](https://ftp.mozilla.org/pub/thunderbird/releases/102.3.0/source/thunderbird-102.3.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
