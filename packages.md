...
|应用软件（详情）|版本（下载）|说明|
|:----|:----|:----|
son/bison-3.8.2.tar.xz)|Bison: a replacement for the parser generator Yacc
...
|[blender](https://www.blender.org/)|[3.3.0](https://download.blender.org/source/blender-3.3.0.tar.xz)|Blender: a very fast and versatile 3D modeller and renderer
...
|[chromium](http://www.chromium.org/Home)|[106.0.5249.91](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[firefox](http://www.mozilla.org/products/firefox/)|[105.0.1](https://ftp.mozilla.org/pub/firefox/releases/105.0.1/source/firefox-105.0.1.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[git](https://git-scm.com/)|[2.37.3](https://github.com/git/git/archive/v2.37.3.tar.gz)|Git: an open source version control system
...
|[ImageMagick](https://imagemagick.org/)|[7.1.0-49](https://github.com/ImageMagick/ImageMagick/archive/7.1.0-49.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[k3b](http://www.k3b.org/)|[22.08.1](https://github.com/KDE/k3b/archive/v22.08.1.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
|[kdevelop](https://www.kdevelop.org/)|[22.08.1](https://github.com/KDE/kdevelop/archive/refs/tags/v22.08.1.tar.gz)|KDevelop: a C/C++ development environment
...
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[22.08.1](https://github.com/KDE/ktorrent/archive/v22.08.1.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[libreoffice](http://www.libreoffice.org/)|[7.4.1](https://download.documentfoundation.org/libreoffice/stable/7.4.1/)|LibreOffice: a free personal productivity suite
...
|[libvirt](http://libvirt.org/)|[8.7.0](https://libvirt.org/sources/libvirt-8.7.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[linux](https://www.kernel.org/)|[5.19.12](https://www.kernel.org/pub/linux/kernel/v5.x/linux-5.19.12.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](http://llvm.org/)|[15.0.1](https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.1/llvm-15.0.1.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[mesa](http://www.mesa3d.org/)|[22.2.0](https://mesa.freedesktop.org/archive/mesa-22.2.0.tar.xz)|Mesa: a 3D graphics library
...
|[opera](https://www.opera.com/)|[91.0.4516.20](https://ftp.opera.com/pub/opera/desktop/91.0.4516.20/linux/)|Opera: a light-weight graphical web browser
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.25.5](https://download.kde.org/stable/plasma/5.25.5/plasma-desktop-5.25.5.tar.xz)|Plasma Desktop: a desktop environment
...
|[systemd](http://www.freedesktop.org/wiki/Software/systemd/)|[251.5](https://github.com/systemd/systemd-stable/archive/refs/tags/v251.5.tar.gz)|systemd: a system and service manager for Linux
...
|[thunderbird](http://www.mozilla.org/products/thunderbird/)|[102.3.1](https://ftp.mozilla.org/pub/thunderbird/releases/102.3.1/source/thunderbird-102.3.1.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[VirtualBox](https://www.virtualbox.org/)|[6.1.38](http://download.virtualbox.org/virtualbox/6.1.38/VirtualBox-6.1.38.tar.bz2)|VirtualBox: a family of x86 virtualisation products for enterprise and home use
|[vivaldi](https://vivaldi.com/)|[5.4.2753.51](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[wireshark](https://www.wireshark.org/)|[3.6.8](https://www.wireshark.org/download/src/wireshark-3.6.8.tar.xz)|Wireshark: a network protocol analyzer
