...
|[apt](https://tracker.debian.org/pkg/apt)|[2.9.8](https://deb.debian.org/debian/pool/main/a/apt/apt_2.9.8.tar.xz)|APT: a front-end for the dpkg package manager
...
|[chromium](http://www.chromium.org/Home)|[128.0.6613.119](https://chromium.googlesource.com/chromium/src/+/refs/tags/128.0.6613.119)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[cups](https://openprinting.github.io/)|[2.4.10](https://github.com/OpenPrinting/cups/releases/download/v2.4.10/cups-2.4.10-source.tar.gz)|CUPS: a UNIX printing system based on the Internet Printing Protocol
...
|[gnome-shell](https://wiki.gnome.org/Projects/GnomeShell)|[46.4](https://download.gnome.org/sources/gnome-shell/46/gnome-shell-46.4.tar.xz)|GNOME Shell: a core user interface of the GNOME 3 desktop
...
|[gstreamer](https://gstreamer.freedesktop.org/)|[1.24.7](https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.7.tar.xz)|GStreamer: a multimedia framework with a plugin-based architecture for a variety of platforms
...
|[k3b](https://apps.kde.org/en-gb/k3b/)|[24.08.0](https://github.com/KDE/k3b/archive/v24.08.0.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
...
|[krita](https://krita.org/)|[5.2.3](https://download.kde.org/stable/krita/5.2.3/krita-5.2.3.tar.xz)|Krita: a cross-platform application that offers an end-to-end solution for creating digital art files from scratch
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[24.08.0](https://github.com/KDE/ktorrent/archive/v24.08.0.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[LibreOffice](https://www.libreoffice.org/)|[24.8.0](https://download.documentfoundation.org/libreoffice/stable/24.8.0/)|LibreOffice: a free personal productivity suite
...
|[libvirt](https://libvirt.org/)|[10.7.0](https://libvirt.org/sources/libvirt-10.7.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[llvm](https://llvm.org/)|[18.1.8](https://github.com/llvm/llvm-project/releases/download/llvmorg-18.1.8/llvm-18.1.8.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[mesa](https://www.mesa3d.org/)|[24.2.2](https://mesa.freedesktop.org/archive/mesa-24.2.2.tar.xz)|Mesa: a 3D graphics library
...
|[NetworkManager](https://networkmanager.dev/)|[1.48.10](https://download.gnome.org/sources/NetworkManager/1.48/NetworkManager-1.48.10.tar.xz)|NetworkManager: a utility aimed at simplifying the use of computer networks on Linux
...
|[qbittorrent](https://www.qbittorrent.org/)|[4.6.6](https://downloads.sourceforge.net/qbittorrent/qbittorrent-4.6.6.tar.xz)|qBittorrent: a P2P BitTorrent client
...
|[samba](https://www.samba.org/)|[4.21.0](https://us1.samba.org/samba/ftp/stable/samba-4.21.0.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[shotwell](https://wiki.gnome.org/Apps/Shotwell)|[0.32.8](https://download.gnome.org/sources/shotwell/0.32/shotwell-0.32.8.tar.xz)|Shotwell: an open-source digital photo organiser for GNOME
...
|[thunderbird](https://www.mozilla.org/products/thunderbird/)|[130.0](https://ftp.mozilla.org/pub/thunderbird/releases/130.0/source/thunderbird-130.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[vivaldi](https://vivaldi.com/)|[6.9.3447.41](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[xfsprogs](https://xfs.wiki.kernel.org/)|[6.10.1](https://www.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-6.10.1.tar.xz)|xfsprogs: a set of utilities for managing the XFS file system
