...
|[apache-tomcat](https://tomcat.apache.org/)|[10.1.8](https://www.apache.org/dist/tomcat/tomcat-10/v10.1.8/src/apache-tomcat-10.1.8-src.tar.gz)|apache-tomcat: a Java Servlet and JSP Container
...
|[blender](https://www.blender.org/)|[3.5.0](https://download.blender.org/source/blender-3.5.0.tar.xz)|Blender: a very fast and versatile 3D modeller and renderer
...
|[calibre](https://calibre-ebook.com/)|[6.15.1](https://download.calibre-ebook.com/6.15.1/calibre-6.15.1.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[112.0.5615.121](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[digikam](https://www.digikam.org/)|[8.0.0](https://download.kde.org/stable/digikam/8.0.0/digiKam-8.0.0.tar.xz)|Digikam: an advanced digital photo management application
...
|[dnf](https://github.com/rpm-software-management/dnf/)|[4.15.0](https://github.com/rpm-software-management/dnf/archive/4.15.0.tar.gz)|DNF: a new package management library and a fork of yum
|[docker](https://www.docker.com/community-edition)|[23.0.3](https://github.com/moby/moby/archive/refs/tags/v23.0.3.tar.gz)|Docker: a program that performs operating-system-level virtualisation, also known as "containerisation"
...
|[firefox](https://www.mozilla.org/products/firefox/)|[112.0](https://ftp.mozilla.org/pub/firefox/releases/112.0/source/firefox-112.0.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[ghostscript](https://www.ghostscript.com/)|[10.01.1](https://github.com/ArtifexSoftware/ghostpdl-downloads/releases/download/gs1001/ghostscript-10.01.1.tar.xz)|Ghostscript: an interpreter for the PostScript language and PDF
...
|[gnucash](https://www.gnucash.org/)|[5.0](https://downloads.sourceforge.net/gnucash/gnucash-5.0.tar.bz2)|GNUCash: an open source personal finance suite
...
|[gstreamer](https://gstreamer.freedesktop.org/)|[1.22.2](https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.22.2.tar.xz)|GStreamer: a multimedia framework with a plugin-based architecture for a variety of platforms
...
|[hplip](https://developers.hp.com/hp-linux-imaging-and-printing)|[3.23.3](https://downloads.sourceforge.net/hplip/hplip-3.23.3.tar.gz)|hplip: Hewlett-Packard's Linux imaging and printing software
...
|[icewm](https://ice-wm.org/)|[3.3.3](https://github.com/ice-wm/icewm/releases/download/3.3.3/icewm-3.3.3.tar.lz)|IceWM: an X Window manager that emulates the looks of Motif, OS/2 and Windows
|[ImageMagick](https://imagemagick.org/)|[7.1.1-6](https://github.com/ImageMagick/ImageMagick/archive/7.1.1-6.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[libreoffice](https://www.libreoffice.org/)|[7.5.2](https://download.documentfoundation.org/libreoffice/stable/7.5.2/)|LibreOffice: a free personal productivity suite
|[libressl](https://www.libressl.org/)|[3.7.2](https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-3.7.2.tar.gz)|LibreSSL: an implementation of SSL and TLS protocols, forked from OpenSSL
...
|[libvirt](https://libvirt.org/)|[9.2.0](https://libvirt.org/sources/libvirt-9.2.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[linux](https://www.kernel.org/)|[6.2.11](https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.2.11.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](https://llvm.org/)|[16.0.1](https://github.com/llvm/llvm-project/releases/download/llvmorg-16.0.1/llvm-16.0.1.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[man-pages](https://www.kernel.org/doc/man-pages/)|[6.04](https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.04.tar.xz)|Man Pages: files containing the manual pages displayed by man
...
|[mesa](https://www.mesa3d.org/)|[23.0.2](https://mesa.freedesktop.org/archive/mesa-23.0.2.tar.xz)|Mesa: a 3D graphics library
...
|[openshot](https://www.openshot.org/)|[3.1.0](https://github.com/OpenShot/openshot-qt/archive/v3.1.0.tar.gz)|OpenShot: a video editor
...
|[openvpn](https://openvpn.net/community/)|[2.6.3](https://swupdate.openvpn.org/community/releases/openvpn-2.6.3.tar.gz)|OpenVPN: an open-source VPN daemon
|[opera](https://www.opera.com/)|[97.0.4719.63](https://ftp.opera.com/pub/opera/desktop/97.0.4719.63/linux/)|Opera: a light-weight graphical web browser
...
|[php](https://www.php.net/)|[8.2.5](https://www.php.net/distributions/php-8.2.5.tar.xz)|PHP: a server-side HTML embedded scripting language
...
|[pipewire](https://pipewire.org/)|[0.3.69](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.69/pipewire-0.3.69.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.27.4](https://download.kde.org/stable/plasma/5.27.4/plasma-desktop-5.27.4.tar.xz)|Plasma Desktop: a desktop environment
|[postfix](https://www.postfix.org/)|[3.8.0](https://de.postfix.org/ftpmirror/official//postfix-3.8.0.tar.gz)|Postfix: a mail transport agent
...
|[qt-creator](https://wiki.qt.io/Qt_Creator)|[10.0.0](https://download.qt.io/official_releases/qtcreator/10.0/10.0.0/qt-creator-opensource-src-10.0.0.tar.gz)|Qt Creator: a cross-platform IDE tailored to the needs of Qt developers
...
|[rust](https://www.rust-lang.org/)|[1.68.2](https://github.com/rust-lang/rust/archive/1.68.2.tar.gz)|Rust: a systems programming language that runs blazingly fast, prevents segfaults and guarantees thread safety
|[samba](https://www.samba.org/)|[4.18.1](https://us1.samba.org/samba/ftp/stable/samba-4.18.1.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[seamonkey](https://www.seamonkey-project.org/)|[2.53.16](https://ftp.mozilla.org/pub/seamonkey/releases/2.53.16/source/seamonkey-2.53.16.source.tar.xz)|Mozilla SeaMonkey: a web browser, e-mail and newsgroup client, IRC chat client and HTML editor
...
|[shotwell](https://wiki.gnome.org/Apps/Shotwell)|[0.30.18](https://download.gnome.org/sources/shotwell/0.30/shotwell-0.30.18.tar.xz)|Shotwell: an open-source digital photo organiser for GNOME
|[snapd](https://snapcraft.io/)|[2.59.1](https://github.com/snapcore/snapd/archive/2.59.1.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
|[snort](https://www.snort.org/)|[3.1.59.0](https://snort.org/downloads/snortplus/snort3-3.1.59.0.tar.gz)|Snort: a light-weight network intrusion detection program
...
|[systemd](https://www.freedesktop.org/wiki/Software/systemd/)|[253.3](https://github.com/systemd/systemd-stable/archive/refs/tags/v253.3.tar.gz)|systemd: a system and service manager for Linux
...
|[thunderbird](https://www.mozilla.org/products/thunderbird/)|[102.10.0](https://ftp.mozilla.org/pub/thunderbird/releases/102.10.0/source/thunderbird-102.10.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[vivaldi](https://vivaldi.com/)|[5.7.2921.68](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[wordpress](https://wordpress.org/)|[6.2](https://wordpress.org/wordpress-6.2.tar.gz)|WordPress: publishing software for the world wide web
...
|[zfs](https://openzfs.org/)|[2.1.10](https://github.com/openzfs/zfs/releases/download/zfs-2.1.10/zfs-2.1.10.tar.gz)|ZFS: an advanced file system and volume manager maintained by the Illumos community
