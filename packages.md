...
- [ Last Update: Tuesday 23 April 2024 06:53 GMT ](https://distrowatch.com/packages.php)  
- 快速下载
- **bash**脚本
...
|[apache-tomcat](https://tomcat.apache.org/)|[10.1.23](https://www.apache.org/dist/tomcat/tomcat-10/v10.1.23/src/apache-tomcat-10.1.23-src.tar.gz)|apache-tomcat: a Java Servlet and JSP Container
|[apt](https://tracker.debian.org/pkg/apt)|[2.9.2](https://deb.debian.org/debian/pool/main/a/apt/apt_2.9.2.tar.xz)|APT: a front-end for the dpkg package manager
|[audacity](https://www.audacityteam.org/)|[3.5.0](https://github.com/audacity/audacity/releases/download/Audacity-3.5.0/audacity-sources-3.5.0.tar.gz)|Audacity: a free audio editor
...
|[bind](https://www.isc.org/downloads/bind/)|[9.18.26](https://ftp.isc.org/isc/bind9/9.18.26/bind-9.18.26.tar.xz)|ISC BIND: an implementation of the Domain Name System (DNS) protocols
...
|[bitcoin](https://bitcoin.org/)|[27.0](https://github.com/bitcoin/bitcoin/archive/v27.0.tar.gz)|Bitcoin: an innovative payment network and a new kind of money
|[blender](https://www.blender.org/)|[4.1.1](https://download.blender.org/source/blender-4.1.1.tar.xz)|Blender: a very fast and versatile 3D modeller and renderer
...
|[calibre](https://calibre-ebook.com/)|[7.9.0](https://download.calibre-ebook.com/7.9.0/calibre-7.9.0.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[124.0.6367.60](https://chromium.googlesource.com/chromium/src/+/refs/tags/124.0.6367.60)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[cmake](https://cmake.org/)|[3.29.2](https://github.com/Kitware/CMake/releases/download/v3.29.2/cmake-3.29.2.tar.gz)|cmake: a cross-platform, open-source build system
...
|[cryptsetup](https://gitlab.com/cryptsetup/cryptsetup)|[2.7.2](https://www.kernel.org/pub/linux/utils/cryptsetup/v2.7/cryptsetup-2.7.2.tar.xz)|cryptsetup: a utility for setting up disk encryption based on the DMCrypt kernel module
...
|[curl](https://curl.se/)|[8.7.1](https://github.com/curl/curl/releases/download/curl-8_1_1/curl-8.7.1.tar.xz)|cURL: a command line tool for transferring files with URL syntax
...
|[dnf](https://github.com/rpm-software-management/dnf/)|[4.19.2](https://github.com/rpm-software-management/dnf/archive/4.19.2.tar.gz)|DNF: a new package management library and a fork of yum
|[docker](https://www.docker.com/community-edition)|[26.1.0](https://github.com/moby/moby/archive/refs/tags/v26.1.0.tar.gz)|Docker: a program that performs operating-system-level virtualisation, also known as "containerisation"
...
|[emacs](https://www.gnu.org/software/emacs/)|[29.3](https://ftp.gnu.org/gnu/emacs/emacs-29.3.tar.xz)|GNU Emacs: the extensible, self-documenting real-time display editor
...
|[evolution](https://wiki.gnome.org/Apps/Evolution)|[3.52.1](https://download.gnome.org/sources/evolution/3.50/evolution-3.52.1.tar.xz)|Evolution: information management software providing mail, address book and calendaring functionality
|[exim](https://www.exim.org/)|[4.97.1](https://ftp.exim.org/pub/exim/exim4/exim-4.97.1.tar.xz)|exim: a mail server
|[ffmpeg](https://ffmpeg.org/)|[7.0](https://ffmpeg.org/releases/ffmpeg-7.0.tar.xz)|FFmpeg: a complete, cross-platform solution to record, convert and stream audio and video
...
|[firefox](https://www.mozilla.org/products/firefox/)|[125.0.2](https://ftp.mozilla.org/pub/firefox/releases/125.0.2/source/firefox-125.0.2.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[flatpak](https://flatpak.org/)|[1.14.6](https://github.com/flatpak/flatpak/releases/download/1.14.6/flatpak-1.14.6.tar.xz)|Flatpak: a framework for Linux application sandboxing and distribution
...
|[gnome-shell](https://wiki.gnome.org/Projects/GnomeShell)|[46.1](https://download.gnome.org/sources/gnome-shell/46/gnome-shell-46.1.tar.xz)|GNOME Shell: a core user interface of the GNOME 3 desktop
|[gnucash](https://www.gnucash.org/)|[5.6](https://github.com/Gnucash/gnucash/releases/download/5.6/gnucash-5.6.tar.bz2)|GNUCash: an open source personal finance suite
...
|[gstreamer](https://gstreamer.freedesktop.org/)|[1.24.2](https://gstreamer.freedesktop.org/src/gstreamer/gstreamer-1.24.2.tar.xz)|GStreamer: a multimedia framework with a plugin-based architecture for a variety of platforms
|[gtk](https://www.gtk.org/)|[4.14.3](https://download.gnome.org/sources/gtk/4.14/gtk-4.14.3.tar.xz)|GTK: a multi-platform toolkit for creating GUIs
...
|[icewm](https://ice-wm.org/)|[3.4.7](https://github.com/ice-wm/icewm/releases/download/3.4.7/icewm-3.4.7.tar.lz)|IceWM: an X Window manager that emulates the looks of Motif, OS/2 and Windows
|[ImageMagick](https://imagemagick.org/)|[7.1.1-31](https://github.com/ImageMagick/ImageMagick/archive/7.1.1-31.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[k3b](https://apps.kde.org/en-gb/k3b/)|[24.02.2](https://github.com/KDE/k3b/archive/v24.02.2.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
|[kdevelop](https://www.kdevelop.org/)|[24.02.2](https://github.com/KDE/kdevelop/archive/refs/tags/v24.02.2.tar.gz)|KDevelop: a C/C++ development environment
...
|[kodi](https://kodi.tv/)|[21.0](https://github.com/xbmc/xbmc/archive/21.0-Omega.tar.gz)|Kodi: a media player and entertainment hub for digital media
...
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[24.02.2](https://github.com/KDE/ktorrent/archive/v24.02.2.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[LibreOffice](https://www.libreoffice.org/)|[24.2.2](https://download.documentfoundation.org/libreoffice/stable/24.2.2/)|LibreOffice: a free personal productivity suite
|[libressl](https://www.libressl.org/)|[3.9.1](https://ftp.openbsd.org/pub/OpenBSD/LibreSSL/libressl-3.9.1.tar.gz)|LibreSSL: an implementation of SSL and TLS protocols, forked from OpenSSL
...
|[libvirt](https://libvirt.org/)|[10.2.0](https://libvirt.org/sources/libvirt-10.2.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[linux](https://www.kernel.org/)|[6.8.7](https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.8.7.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](https://llvm.org/)|[18.1.4](https://github.com/llvm/llvm-project/releases/download/llvmorg-18.1.4/llvm-18.1.4.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[lxqt-panel](https://github.com/lxqt/lxqt-panel)|[2.0.0](https://github.com/lxde/lxqt-panel/releases/download/2.0.0/lxqt-panel-2.0.0.tar.xz)|LXQt: a Qt port of the LXDE desktop environment
...
|[man-db](https://man-db.nongnu.org/)|[2.12.1](https://download.savannah.nongnu.org/releases/man-db/man-db-2.12.1.tar.xz)|man-db: an implementation of the standard UNIX documentation system
|[man-pages](https://www.kernel.org/doc/man-pages/)|[6.7](https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.7.tar.xz)|Man Pages: files containing the manual pages displayed by man
...
|[mesa](https://www.mesa3d.org/)|[24.0.5](https://mesa.freedesktop.org/archive/mesa-24.0.5.tar.xz)|Mesa: a 3D graphics library
...
|[nautilus](https://wiki.gnome.org/Apps/Files)|[46.1](https://download.gnome.org/sources/nautilus/46/nautilus-46.1.tar.xz)|Nautilus: a file manager for the GNOME desktop
...
|[nmap](https://www.insecure.org/nmap/)|[7.95](https://download.insecure.org/nmap/dist/nmap-7.95.tgz)|Nmap: a utility for network exploration or security auditing
...
|[NVIDIA](https://www.nvidia.com/object/unix.html)|[550.76](https://us.download.nvidia.com/XFree86/Linux-x86_64/550.76/NVIDIA-Linux-x86_64-550.76.run)|NVIDIA: a proprietary display driver for Linux, FreeBSD and Solaris
|[octave](https://www.gnu.org/software/octave/)|[9.1.0](https://ftp.gnu.org/gnu/octave/octave-9.1.0.tar.xz)|GNU Octave: a high-level interpreted language intended for numerical computations
...
|[openjdk](https://openjdk.org/)|[22](https://github.com/openjdk/jdk/archive/refs/tags/jdk-22-ga.tar.gz)|OpenJDK: a complete and free implementation of Java SE, the core Java platform
...
|[openssl](https://www.openssl.org/)|[3.3.0](https://ftp.openssl.org/source/openssl-3.3.0.tar.gz)|OpenSSL: a library for providing encrypted transport layers
...
|[opera](https://www.opera.com/)|[109.0.5097.45](https://ftp.opera.com/pub/opera/desktop/109.0.5097.45/linux/)|Opera: a light-weight graphical web browser
...
|[php](https://www.php.net/)|[8.3.6](https://www.php.net/distributions/php-8.3.6.tar.xz)|PHP: a server-side HTML embedded scripting language
...
|[pipewire](https://pipewire.org/)|[1.0.5](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/1.0.5/pipewire-1.0.5.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[6.0.4](https://download.kde.org/stable/plasma/6.0.4/plasma-desktop-6.0.4.tar.xz)|Plasma Desktop: a desktop environment
...
|[Python](https://www.python.org/)|[3.12.3](https://www.python.org/ftp/python/3.12.3/Python-3.12.3.tgz)|Python: an interpreted, interactive, object-oriented programming language
|[qbittorrent](https://www.qbittorrent.org/)|[4.6.4](https://downloads.sourceforge.net/qbittorrent/qbittorrent-4.6.4.tar.xz)|qBittorrent: a P2P BitTorrent client
...
|[qt](https://www.qt.io/)|[6.7.0](https://download.qt-project.org/official_releases/qt/6.7/6.7.0/single/qt-everywhere-src-6.7.0.tar.xz)|Qt: a C++ application framework for writing graphical applications
...
|[rsync](https://rsync.samba.org/)|[3.3.0](https://rsync.samba.org/ftp/rsync/rsync-3.3.0.tar.gz)|rsync: an open source utility that provides fast, incremental file transfer
...
|[rust](https://www.rust-lang.org/)|[1.77.2](https://github.com/rust-lang/rust/archive/1.77.2.tar.gz)|Rust: a systems programming language that runs blazingly fast, prevents segfaults and guarantees thread safety
|[samba](https://www.samba.org/)|[4.20.0](https://us1.samba.org/samba/ftp/stable/samba-4.20.0.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[snapd](https://snapcraft.io/)|[2.62](https://github.com/snapcore/snapd/archive/2.62.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
|[snort](https://www.snort.org/)|[3.1.84.0](https://snort.org/downloads/snortplus/snort3-3.1.84.0.tar.gz)|Snort: a light-weight network intrusion detection program
...
|[sqlite](https://www.sqlite.org/)|[3.45.3](https://github.com/sqlite/sqlite/archive/refs/tags/version-3.45.3.tar.gz)|SQLite: an embeddable SQL engine in a C library
|[squid](http://www.squid-cache.org/)|[6.9](http://www.squid-cache.org/Versions/v6/squid-6.9.tar.gz)|Squid: a full-featured web proxy cache
...
|[texlive](https://www.tug.org/texlive/)|[2024](https://tug.org/texlive/Images/texlive2024.iso)|TeX Live: a collection of programs for typesetting, previewing and printing of TeX documents
|[thunderbird](https://www.mozilla.org/products/thunderbird/)|[115.10.1](https://ftp.mozilla.org/pub/thunderbird/releases/115.10.1/source/thunderbird-115.10.1.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[tor](https://www.torproject.org/)|[0.4.8.11](https://www.torproject.org/dist/tor-0.4.8.11.tar.gz)|Tor: a network of virtual tunnels that allows people to improve privacy and security on the Internet
...
|[util-linux](https://github.com/karelzak/util-linux)|[2.40](https://www.kernel.org/pub/linux/utils/util-linux/v2.40/util-linux-2.40.tar.xz)|util-linux: a collection of essential utilities for Linux systems
...
|[VirtualBox](https://www.virtualbox.org/)|[7.0.16](https://download.virtualbox.org/virtualbox/7.0.16/VirtualBox-7.0.16.tar.bz2)|VirtualBox: a family of x86 virtualisation products for enterprise and home use
|[vivaldi](https://vivaldi.com/)|[6.6.3271.61](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[webmin](https://www.webmin.com/)|[2.111](https://downloads.sourceforge.net/webadmin/webmin-2.111.tar.gz)|Webmin: a web-based interface for Unix system administration
...
|[wireshark](https://www.wireshark.org/)|[4.2.4](https://www.wireshark.org/download/src/wireshark-4.2.4.tar.xz)|Wireshark: a network protocol analyzer
|[wordpress](https://wordpress.org/)|[6.5.2](https://wordpress.org/wordpress-6.5.2.tar.gz)|WordPress: publishing software for the world wide web
...
|[xfsprogs](https://xfs.wiki.kernel.org/)|[6.7.0](https://www.kernel.org/pub/linux/utils/fs/xfs/xfsprogs/xfsprogs-6.7.0.tar.xz)|xfsprogs: a set of utilities for managing the XFS file system
