...
- Last Update: Monday 28 March 2022 09:05 GMT
```
...
apt 	2.4.3 	APT: a front-end for the dpkg package manager
...
calibre 	5.39.1 	Calibre: an e-book library management application
...
chromium 	99.0.4844.84 	Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
docker 	20.10.14 	Docker: a program that performs operating-system-level virtualisation, also known as "containerisation"
...
firefox 	98.0.2 	Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
gnucash 	4.10 	GNUCash: an open source personal finance suite
...
ImageMagick 	7.1.0-29 	ImageMagick: a software suite to create, edit and compose bitmap images
...
linux 	5.17.1 	Linux kernel: a UNIX clone written from scratch by Linus Torvalds
llvm 	14.0.0 	LLVM: a collection of modular and reusable compiler and toolchain technologies
...
mc 	4.8.28 	GNU Midnight Commander: a file manager
...
mutt 	2.2.2 	Mutt: a text-based MIME Email client
...
nautilus 	42.0 	Nautilus: a file manager for the GNOME desktop
...
NetworkManager 	1.36.4 	NetworkManager: a utility aimed at simplifying the use of computer networks on Linux
...
openjdk 	18 	OpenJDK: a complete and free implementation of Java SE, the core Java platform
...
opera 	85.0.4341.18 	Opera: a light-weight graphical web browser
...
qbittorrent 	4.4.2 	qBittorrent: a P2P BitTorrent client
...
qt-creator 	7.0.0 	Qt Creator: a cross-platform IDE tailored to the needs of Qt developers
...
samba 	4.16.0 	Samba: a free software re-implementation of SMB/CIFS networking protocol
...
seamonkey 	2.53.11.1 	Mozilla SeaMonkey: a web browser, e-mail and newsgroup client, IRC chat client and HTML editor
...
snapd 	2.55.2 	snapd: a tool to support and manage .snap applications that are portable across different Linux systems
...
vlc 	3.0.17.4 	VLC: a cross-platform media player and streaming server
...
zfs 	2.1.4 	ZFS: an advanced file system and volume manager maintained by the Illumos community
