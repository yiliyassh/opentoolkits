...
- [ Last Update: Saturday 2 September 2023 08:53 GMT ](https://distrowatch.com/packages.php)  
- 快速下载
- **bash**脚本
...
|[bind](https://www.isc.org/downloads/bind/)|[9.18.18](https://ftp.isc.org/isc/bind9/9.18.18/bind-9.18.18.tar.xz)|ISC BIND: an implementation of the Domain Name System (DNS) protocols
...
|[blender](https://www.blender.org/)|[3.6.2](https://download.blender.org/source/blender-3.6.2.tar.xz)|Blender: a very fast and versatile 3D modeller and renderer
...
|[calibre](https://calibre-ebook.com/)|[6.25.0](https://download.calibre-ebook.com/6.25.0/calibre-6.25.0.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[116.0.5845.140](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[cmake](https://cmake.org/)|[3.27.4](https://github.com/Kitware/CMake/releases/download/v3.27.4/cmake-3.27.4.tar.gz)|cmake: a cross-platform, open-source build system
...
|[firefox](https://www.mozilla.org/products/firefox/)|[117.0](https://ftp.mozilla.org/pub/firefox/releases/117.0/source/firefox-117.0.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[gnome-shell](https://wiki.gnome.org/Projects/GnomeShell)|[44.4](https://download.gnome.org/sources/gnome-shell/44/gnome-shell-44.4.tar.xz)|GNOME Shell: a core user interface of the GNOME 3 desktop
...
|[gtk](https://www.gtk.org/)|[4.12.1](https://download.gnome.org/sources/gtk/4.10/gtk-4.12.1.tar.xz)|GTK: a multi-platform toolkit for creating GUIs
...
|[k3b](https://apps.kde.org/en-gb/k3b/)|[23.08.0](https://github.com/KDE/k3b/archive/v23.08.0.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
|[kdevelop](https://www.kdevelop.org/)|[23.08.0](https://github.com/KDE/kdevelop/archive/refs/tags/v23.08.0.tar.gz)|KDevelop: a C/C++ development environment
...
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[23.08.0](https://github.com/KDE/ktorrent/archive/v23.08.0.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[libreoffice](https://www.libreoffice.org/)|[7.6.0](https://download.documentfoundation.org/libreoffice/stable/7.6.0/)|LibreOffice: a free personal productivity suite
...
|[linux](https://www.kernel.org/)|[6.5](https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.5.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
...
|[mesa](https://www.mesa3d.org/)|[23.1.6](https://mesa.freedesktop.org/archive/mesa-23.1.6.tar.xz)|Mesa: a 3D graphics library
...
|[mutt](http://www.mutt.org/)|[2.2.11](http://ftp.mutt.org/pub/mutt/mutt-2.2.11.tar.gz)|Mutt: a text-based MIME Email client
...
|[NVIDIA](https://www.nvidia.com/object/unix.html)|[535.104.05](https://us.download.nvidia.com/XFree86/Linux-x86_64/535.104.05/NVIDIA-Linux-x86_64-535.104.05.run)|NVIDIA: a proprietary display driver for Linux, FreeBSD and Solaris
...
|[opera](https://www.opera.com/)|[102.0.4880.33](https://ftp.opera.com/pub/opera/desktop/102.0.4880.33/linux/)|Opera: a light-weight graphical web browser
...
|[pipewire](https://pipewire.org/)|[0.3.79](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.79/pipewire-0.3.79.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.27.7.1](https://download.kde.org/stable/plasma/5.27.7/plasma-desktop-5.27.7.1.tar.xz)|Plasma Desktop: a desktop environment
...
|[postgresql](https://www.postgresql.org/)|[15.4](https://ftp.postgresql.org/pub/source/v15.4/postgresql-15.4.tar.bz2)|PostgreSQL: a relational database management system
...
|[qemu](https://qemu.org/)|[8.1.0](https://wiki.qemu.org/download/qemu-8.1.0.tar.xz)|QEMU: an open source machine emulator and virtualiser
...
|[rust](https://www.rust-lang.org/)|[1.72.0](https://github.com/rust-lang/rust/archive/1.72.0.tar.gz)|Rust: a systems programming language that runs blazingly fast, prevents segfaults and guarantees thread safety
|[samba](https://www.samba.org/)|[4.18.6](https://us1.samba.org/samba/ftp/stable/samba-4.18.6.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[snapd](https://snapcraft.io/)|[2.60.3](https://github.com/snapcore/snapd/archive/2.60.3.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
|[snort](https://www.snort.org/)|[3.1.69.0](https://snort.org/downloads/snortplus/snort3-3.1.69.0.tar.gz)|Snort: a light-weight network intrusion detection program
...
|[sqlite](https://www.sqlite.org/)|[3.43.0](https://github.com/sqlite/sqlite/archive/refs/tags/version-3.43.0.tar.gz)|SQLite: an embeddable SQL engine in a C library
|[squid](http://www.squid-cache.org/)|[6.2](http://www.squid-cache.org/Versions/v6/squid-6.2.tar.gz)|Squid: a full-featured web proxy cache
...
|[systemd](https://www.freedesktop.org/wiki/Software/systemd/)|[254.1](https://github.com/systemd/systemd-stable/archive/refs/tags/v254.1.tar.gz)|systemd: a system and service manager for Linux
...
|[thunderbird](https://www.mozilla.org/products/thunderbird/)|[115.2.0](https://ftp.mozilla.org/pub/thunderbird/releases/115.2.0/source/thunderbird-115.2.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[tor](https://www.torproject.org/)|[0.4.8.5](https://www.torproject.org/dist/tor-0.4.8.5.tar.gz)|Tor: a network of virtual tunnels that allows people to improve privacy and security on the Internet
...
|[vivaldi](https://vivaldi.com/)|[6.2.3105.45](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
