...
|[apache-tomcat](http://tomcat.apache.org/)|[10.1.1](http://www.apache.org/dist/tomcat/tomcat-10/v10.1.1/src/apache-tomcat-10.1.1-src.tar.gz)|apache-tomcat: a Java Servlet and JSP Container
|[apt](https://tracker.debian.org/pkg/apt)|[2.5.3](https://deb.debian.org/debian/pool/main/a/apt/apt_2.5.3.tar.xz)|APT: a front-end for the dpkg package manager
|[audacity](http://www.audacityteam.org/)|[3.2.1](http://www.fosshub.com/Audacity.html/audacity-minsrc-3.2.1.tar.xz)|Audacity: a free audio editor
...
|[bind](http://www.isc.org/downloads/bind/)|[9.18.8](https://ftp.isc.org/isc/bind9/9.18.8/bind-9.18.8.tar.xz)|ISC BIND: an implementation of the Domain Name System (DNS) protocols
...
|[calibre](http://calibre-ebook.com/)|[6.7.0](https://download.calibre-ebook.com/6.7.0/calibre-6.7.0.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[107.0.5304.68](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
|[cinnamon](https://github.com/linuxmint/cinnamon/)|[5.4.12](https://github.com/linuxmint/Cinnamon/archive/5.4.12.tar.gz)|Cinnamon: a desktop environment developed by Linux Mint
...
|[digikam](https://www.digikam.org/)|[7.8.0](https://download.kde.org/stable/digikam/7.8.0/digikam-7.8.0.tar.xz)|Digikam: an advanced digital photo management application
...
|[evolution](https://wiki.gnome.org/Apps/Evolution)|[3.46.1](https://download.gnome.org/sources/evolution/3.42/evolution-3.46.1.tar.xz)|Evolution: information management software providing mail, address book and calendaring functionality
...
|[firefox](http://www.mozilla.org/products/firefox/)|[106.0.2](https://ftp.mozilla.org/pub/firefox/releases/106.0.2/source/firefox-106.0.2.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[flatpak](http://flatpak.org)|[1.15.0](https://github.com/flatpak/flatpak/releases/download/1.15.0/flatpak-1.15.0.tar.xz)|Flatpak: a framework for Linux application sandboxing and distribution
...
|[gawk](http://www.gnu.org/software/gawk/gawk.html)|[5.2.0](https://ftp.gnu.org/gnu/gawk/gawk-5.2.0.tar.xz)|GNU Gawk: a free version of awk, a string manipulation language
...
|[gnome-shell](https://wiki.gnome.org/Projects/GnomeShell)|[43.0](https://download.gnome.org/sources/gnome-shell/42/gnome-shell-43.0.tar.xz)|GNOME Shell: a core user interface of the GNOME 3 desktop
...
|[icewm](https://ice-wm.org/)|[3.1.0](https://github.com/ice-wm/icewm/releases/download/3.1.0/icewm-3.1.0.tar.lz)|IceWM: an X Window manager that emulates the looks of Motif, OS/2 and Windows
|[ImageMagick](https://imagemagick.org/)|[7.1.0-51](https://github.com/ImageMagick/ImageMagick/archive/7.1.0-51.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[k3b](http://www.k3b.org/)|[22.08.2](https://github.com/KDE/k3b/archive/v22.08.2.tar.gz)|K3b: a KDE-GUI for cdrecord and cdrdao, similar to Nero
|[kdevelop](https://www.kdevelop.org/)|[22.08.2](https://github.com/KDE/kdevelop/archive/refs/tags/v22.08.2.tar.gz)|KDevelop: a C/C++ development environment
...
|[krita](https://krita.org/)|[5.1.1](https://download.kde.org/stable/krita/5.1.1/krita-5.1.1.tar.xz)|Krita: a cross-platform application that offers an end-to-end solution for creating digital art files from scratch
...
|[ktorrent](https://www.kde.org/applications/internet/ktorrent/)|[22.08.2](https://github.com/KDE/ktorrent/archive/v22.08.2.tar.gz)|KTorrent: a BitTorrent program for KDE
...
|[libreoffice](http://www.libreoffice.org/)|[7.4.2](https://download.documentfoundation.org/libreoffice/stable/7.4.2/)|LibreOffice: a free personal productivity suite
...
|[libvirt](http://libvirt.org/)|[8.8.0](https://libvirt.org/sources/libvirt-8.8.0.tar.xz)|libvirt: a toolkit to interact with the virtualization capabilities of the Linux kernel
...
|[linux](https://www.kernel.org/)|[6.0.5](https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.0.5.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](http://llvm.org/)|[15.0.3](https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.3/llvm-15.0.3.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[mesa](http://www.mesa3d.org/)|[22.2.2](https://mesa.freedesktop.org/archive/mesa-22.2.2.tar.xz)|Mesa: a 3D graphics library
...
|[nautilus](https://wiki.gnome.org/Apps/Files)|[43.0](https://download.gnome.org/sources/nautilus/42/nautilus-43.0.tar.xz)|Nautilus: a file manager for the GNOME desktop
...
|[NetworkManager](https://wiki.gnome.org/Projects/NetworkManager)|[1.40.2](https://download.gnome.org/sources/NetworkManager/1.40/NetworkManager-1.40.2.tar.xz)|NetworkManager: a utility aimed at simplifying the use of computer networks on Linux
...
|[NVIDIA](http://www.nvidia.com/object/unix.html)|[520.56.06](https://us.download.nvidia.com/XFree86/Linux-x86_64/520.56.06/NVIDIA-Linux-x86_64-520.56.06.run)|NVIDIA: a proprietary display driver for Linux, FreeBSD and Solaris
...
|[openjdk](https://openjdk.java.net/)|[19](https://download.java.net/java/GA/jdk19/877d6127e982470ba2a7faa31cc93d04/36/GPL/openjdk-19_linux-x64_bin.tar.gz)|OpenJDK: a complete and free implementation of Java SE, the core Java platform
...
|[opera](https://www.opera.com/)|[92.0.4561.21](https://ftp.opera.com/pub/opera/desktop/92.0.4561.21/linux/)|Opera: a light-weight graphical web browser
...
|[pipewire](https://pipewire.org/)|[0.3.59](https://gitlab.freedesktop.org/pipewire/pipewire/-/archive/0.3.59/pipewire-0.3.59.tar.bz2)|PipeWire: a server for handling audio and video streams and hardware on Linux
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.26.1](https://download.kde.org/stable/plasma/5.26.1/plasma-desktop-5.26.1.tar.xz)|Plasma Desktop: a desktop environment
...
|[postgresql](https://www.postgresql.org/)|[15.0](https://ftp.postgresql.org/pub/source/v15.0/postgresql-15.0.tar.bz2)|PostgreSQL: a relational database management system
...
|[Python](https://www.python.org/)|[3.11.0](https://www.python.org/ftp/python/3.11.0/Python-3.11.0.tgz)|Python: an interpreted, interactive, object-oriented programming language
|[qbittorrent](https://www.qbittorrent.org/)|[4.4.5](http://downloads.sourceforge.net/qbittorrent/qbittorrent-4.4.5.tar.xz)|qBittorrent: a P2P BitTorrent client
...
|[qt-creator](https://wiki.qt.io/Qt_Creator)|[8.0.2](https://download.qt.io/official_releases/qtcreator/7.0/8.0.2/qt-creator-opensource-src-8.0.2.tar.gz)|Qt Creator: a cross-platform IDE tailored to the needs of Qt developers
...
|[rust](https://www.rust-lang.org/)|[1.64.0](https://github.com/rust-lang/rust/archive/1.64.0.tar.gz)|Rust: a systems programming language that runs blazingly fast, prevents segfaults and guarantees thread safety
|[samba](https://www.samba.org/)|[4.17.2](https://us1.samba.org/samba/ftp/stable/samba-4.17.2.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[snapd](https://snapcraft.io/)|[2.57.5](https://github.com/snapcore/snapd/archive/2.57.5.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
|[snort](https://www.snort.org/)|[3.1.43.0](https://snort.org/downloads/snortplus/snort3-3.1.43.0.tar.gz)|Snort: a light-weight network intrusion detection program
...
|[systemd](http://www.freedesktop.org/wiki/Software/systemd/)|[251.7](https://github.com/systemd/systemd-stable/archive/refs/tags/v251.7.tar.gz)|systemd: a system and service manager for Linux
...
|[thunderbird](http://www.mozilla.org/products/thunderbird/)|[102.4.0](https://ftp.mozilla.org/pub/thunderbird/releases/102.4.0/source/thunderbird-102.4.0.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[VirtualBox](https://www.virtualbox.org/)|[7.0.2](http://download.virtualbox.org/virtualbox/7.0.2/VirtualBox-7.0.2.tar.bz2)|VirtualBox: a family of x86 virtualisation products for enterprise and home use
|[vivaldi](https://vivaldi.com/)|[5.5.2805.38](https://source.vivaldi.com/vivaldi-source_5.2.2623.tar.xz)|Vivaldi: a free, cross-platform, proprietary web browser developed by Vivaldi Technologies
...
|[webmin](http://www.webmin.com/)|[2.001](http://downloads.sourceforge.net/webadmin/webmin-2.001.tar.gz)|Webmin: a web-based interface for Unix system administration
...
|[wireshark](https://www.wireshark.org/)|[4.0.0](https://www.wireshark.org/download/src/wireshark-4.0.0.tar.xz)|Wireshark: a network protocol analyzer
|[wordpress](https://wordpress.org/)|[6.0.3](https://wordpress.org/wordpress-6.0.3.tar.gz)|WordPress: publishing software for the world wide web
...
|[xz](https://tukaani.org/xz/)|[5.2.7](https://tukaani.org/xz/xz-5.2.7.tar.xz)|XZ Utils: data compression software with high compression ratio
|[zfs](https://openzfs.org/)|[2.1.6](https://github.com/openzfs/zfs/releases/download/zfs-2.1.6/zfs-2.1.6.tar.gz)|ZFS: an advanced file system and volume manager maintained by the Illumos community
