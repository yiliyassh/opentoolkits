...
- [ Last Update: Friday 14 October 2022 02:53 GMT ](https://distrowatch.com/packages.php)  
- 快速下载
- **bash**脚本
...
|[calibre](http://calibre-ebook.com/)|[6.6.1](https://download.calibre-ebook.com/6.6.1/calibre-6.6.1.tar.xz)|Calibre: an e-book library management application
...
|[chromium](http://www.chromium.org/Home)|[106.0.5249.119](http://src.chromium.org/viewvc/chrome/)|Google Chromium: an open-source edition of Google Chrome, a graphical web browser
...
|[docker](https://www.docker.com/community-edition)|[20.10.19](https://github.com/moby/moby/archive/refs/tags/v20.10.19.tar.gz)|Docker: a program that performs operating-system-level virtualisation, also known as "containerisation"
...
|[evolution](https://wiki.gnome.org/Apps/Evolution)|[3.46.0](https://download.gnome.org/sources/evolution/3.42/evolution-3.46.0.tar.xz)|Evolution: information management software providing mail, address book and calendaring functionality
...
|[firefox](http://www.mozilla.org/products/firefox/)|[105.0.3](https://ftp.mozilla.org/pub/firefox/releases/105.0.3/source/firefox-105.0.3.source.tar.xz)|Mozilla Firefox: a web browser for Windows, Linux, macOS, FreeBSD and Android
...
|[git](https://git-scm.com/)|[2.38.0](https://github.com/git/git/archive/v2.38.0.tar.gz)|Git: an open source version control system
...
|[gtk](https://www.gtk.org/)|[4.8.1](https://download.gnome.org/sources/gtk/4.8/gtk-4.8.1.tar.xz)|GTK: a multi-platform toolkit for creating GUIs
...
|[icewm](https://ice-wm.org/)|[3.0.1](https://github.com/ice-wm/icewm/releases/download/3.0.1/icewm-3.0.1.tar.lz)|IceWM: an X Window manager that emulates the looks of Motif, OS/2 and Windows
|[ImageMagick](https://imagemagick.org/)|[7.1.0-50](https://github.com/ImageMagick/ImageMagick/archive/7.1.0-50.tar.gz)|ImageMagick: a software suite to create, edit and compose bitmap images
...
|[linux](https://www.kernel.org/)|[6.0.1](https://www.kernel.org/pub/linux/kernel/v6.x/linux-6.0.1.tar.xz)|Linux kernel: a UNIX clone written from scratch by Linus Torvalds
|[llvm](http://llvm.org/)|[15.0.2](https://github.com/llvm/llvm-project/releases/download/llvmorg-15.0.2/llvm-15.0.2.src.tar.xz)|LLVM: a collection of modular and reusable compiler and toolchain technologies
...
|[man-pages](https://www.kernel.org/doc/man-pages/)|[6.00](https://www.kernel.org/pub/linux/docs/man-pages/man-pages-6.00.tar.xz)|Man Pages: files containing the manual pages displayed by man
...
|[mesa](http://www.mesa3d.org/)|[22.2.1](https://mesa.freedesktop.org/archive/mesa-22.2.1.tar.xz)|Mesa: a 3D graphics library
...
|[opera](https://www.opera.com/)|[91.0.4516.65](https://ftp.opera.com/pub/opera/desktop/91.0.4516.65/linux/)|Opera: a light-weight graphical web browser
...
|[plasma-desktop](https://kde.org/plasma-desktop/)|[5.26.0](https://download.kde.org/stable/plasma/5.26.0/plasma-desktop-5.26.0.tar.xz)|Plasma Desktop: a desktop environment
...
|[Python](https://www.python.org/)|[3.10.8](https://www.python.org/ftp/python/3.10.8/Python-3.10.8.tgz)|Python: an interpreted, interactive, object-oriented programming language
...
|[samba](https://www.samba.org/)|[4.17.0](https://us1.samba.org/samba/ftp/stable/samba-4.17.0.tar.gz)|Samba: a free software re-implementation of SMB/CIFS networking protocol
...
|[snapd](https://snapcraft.io/)|[2.57.4](https://github.com/snapcore/snapd/archive/2.57.4.tar.gz)|snapd: a tool to support and manage .snap applications that are portable across different Linux systems
...
|[systemd](http://www.freedesktop.org/wiki/Software/systemd/)|[251.6](https://github.com/systemd/systemd-stable/archive/refs/tags/v251.6.tar.gz)|systemd: a system and service manager for Linux
...
|[thunderbird](http://www.mozilla.org/products/thunderbird/)|[102.3.3](https://ftp.mozilla.org/pub/thunderbird/releases/102.3.3/source/thunderbird-102.3.3.source.tar.xz)|Mozilla Thunderbird: a full-featured e-mail and newsgroup client
...
|[VirtualBox](https://www.virtualbox.org/)|[7.0.0](http://download.virtualbox.org/virtualbox/7.0.0/VirtualBox-7.0.0.tar.bz2)|VirtualBox: a family of x86 virtualisation products for enterprise and home use
...
|[wordpress](https://wordpress.org/)|[6.0.2](https://wordpress.org/wordpress-6.0.2.tar.gz)|WordPress: publishing software for the world wide web
